            ...
            <div class="w3-code cssHigh notranslate">
				...
				if ($result = mysqli_query($conn, $sqlG)) {
					while ($row = mysqli_fetch_assoc($result)) {
                       array_push($optionsEspec, "\t\t\t<option value='". $row["id_necessidade"]."'>".$row["Nome_necessidade"]."</option>\n");
					}
				}
                ...
                <div class="w3-responsive w3-card-4">
					...
					<tr>
						...
						<input class="w3-input w3-border w3-light-grey" name="Nome" type="text" pattern="[a-zA-Z\u00C0-\u00FF ]{3,100}$"
