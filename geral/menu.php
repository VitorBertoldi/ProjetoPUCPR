	...
	<div class="w3-top"   > 
		<div class="w3-row w3-white w3-padding" >
			<div class="w3-half" style="margin:0 0 0 0">
				<a href="."><img src='imagens/logo.jpeg' alt=' Clínica Médica ABC '></a>
			</div>
		...
		<div class="w3-bar w3-theme w3-large" style="z-index:-1">
			...
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-light-gray w3-padding-16" href="medListar.php" onclick="w3_show_nav('menuMedico')">Aluno</a>
		</div>
	</div>
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-animate-left" style="z-index:3;width:270px" id="mySidebar" >
		...
		<div id="menuMedico" class="myMenu">
			...
			<a class="w3-bar-item w3-button" href="medListar.php">Relação de Alunos</a>
